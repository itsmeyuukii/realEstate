                                ...
                                <div class="card border-0">
                                    ...
                                    <div class="px-2 pb-2">
                                        <a href="single-property-1.html" class="text-white">
                                            <h5 class="card-title fs-16 lh-2 mb-0">Villa on Hollywood Boulevard</h5>
                                        </a>
                ...
                <div class="py-5 px-4 border rounded-lg shadow-hover-1 bg-white mb-4" data-animate="fadeInUp">
                    <div class="media flex-column flex-sm-row no-gutters">
                        <div class="col-sm-3 mr-sm-5 card border-0 hover-change-image bg-hover-overlay mb-sm-5">
                            <img src="<?= base_url('theme/images/properties-list-03.jpg') ?>" class="card-img" alt="Home in Metric Way">
                    ...
                    <!-- This show if the offer is for sale -->
