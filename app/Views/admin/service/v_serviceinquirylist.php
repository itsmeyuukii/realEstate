    ...
    <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10 invoice-listing">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 d-flex justify-content-md-start justify-content-center">
                    <div class="d-flex form-group mb-0 align-items-center">
                        ...
                        <select name="list_length" id="list_length" aria-controls="inquiry-list"
                ...
                <div class="col-sm-12 col-md-6 d-flex justify-content-md-end justify-content-center mt-md-0 mt-3">
                    ...
                    <div class="align-self-center">
                        <button class="btn btn-danger btn-lg" tabindex="0"
                            aria-controls="inquiry-list"><span>Delete</span></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="table-responsive">
            <?php if (count($inquiries) > 0): ?>
                <table id="inquiry-list" class="table table-hover bg-white border rounded-lg">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="py-6 text-center">First Name</th>
                            <th class="py-6 text-center">Last Name</th>
                            <th class="py-6 text-center">Email</th>
                            <th class="py-6 text-center">Message</th>
                    ...
                    <tbody>
                        <?php foreach ($inquiries as $inquiry): ?>
                            <tr role="row">
                                ...
                                <td class="align-middle text-center">
                                    <a href="<?= base_url('admin/inquiries/' . $inquiry['id']) ?>"
                ...
                <div class="mt-6 text-center">
                    Showing
                    <?= (($page * $perPage) - $perPage + 1) . "-" . (($page * $perPage) - $perPage + count($inquiries)) ?>
                    Result out of
                    <?= number_format($total) ?>
                </div>
            <?php else: ?>
