            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 d-flex justify-content-md-start justify-content-center">
                    ...
                    <div class="align-self-center">
                        <a class="btn btn-primary btn-lg" tabindex="0" aria-controls="pagecontent-list" href="<?= base_url('cms/addpage')?>" >
                            <span>Add New</span>
                        </a>
                    </div>
                </div>
        ...
        <div class="table-responsive">
            <?php if (count($contentpages) > 0): ?>
                <table id="property-list" class="table table-hover bg-white border rounded-lg">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="py-6">Id</th>
                            <th class="py-6">Meta Key</th>
                            <th class="py-6">Page Title</th>
                            <th class="py-6">Updated at</th>
                            <th class="py-6">Slug</th>
                            ...
                            <tr role="row">
                                ...
                                <td class="align-middle">
                                    <span class="badge badge-green text-capitalize">
                                        <?= $contentpage['is_display'] ?>
                                    </span>
                                </td>
                                <td class="align-middle">
                                    <a href="<?= base_url('cms/edit/' . $contentpage['id']) ?>"
                                    ...
                                    <a href="#" data-toggle="modal" data-target="#deleteConfirmationModal"
                                        data-pagecontent-id="<?= $contentpage['id'] ?>"
                                        class="delete-pagecontent-btn d-inline-block fs-18 text-muted hover-primary">
                ...
                <div class="mt-6 text-center">
                    Showing
                    <?= (($page * $perPage) - $perPage + 1) . "-" . (($page * $perPage) - $perPage + count($contentpages)) ?>
                    Result out of
                    <?= number_format($total) ?>
                </div>
            <?php else: ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this page Content?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <a href="<?= base_url('cms/content' . $contentpage['id']) ?>"
