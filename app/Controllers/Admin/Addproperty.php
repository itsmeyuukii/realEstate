...
class Addproperty extends Controller
{
    protected $locModel;
    protected $email;
    protected $addPropertyModel;
    public function __construct()
    {
        $this->locModel = new LocationModel();
        $this->addPropertyModel = new PropertyModel();
    ...
    public function index()
    {
        ...
        if ($this->request->getMethod() == "post") {
            ...
            try {
                $this->addPropertyModel->insertImages($imageData);
                $this->addPropertyModel->insertPropertylists($propertyData);
            } catch (\Exception $e) {
