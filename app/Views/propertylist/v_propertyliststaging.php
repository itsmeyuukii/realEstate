                        ...
                        <?php foreach ($properties as $property): ?>
                            <tr role="row">
                                ...
                                <td class="align-middle">
                                    ...
                                    </span><?= $property->p_code ?>
                                </td>
                                <td class="align-middle">
                                    <span class="text-primary pr-1">
                                    </span><?= $property->p_type ?>
                                </td>
                                <td class="align-middle">
                                    <span class="text-success pr-1">
                                        <i class="fal fa-calendar"></i>
                                    </span><?= $property->p_title ?>
                                </td>
                                <td class="align-middle">
                                    <span class="inv-amount"><?= $property->price ?></span>
                                </td>
                                <td class="align-middle">
                                    <span class="badge badge-green text-capitalize"><?= $property->v_status ?></span>
                                </td>
                                <td class="align-middle">
                                    <a href="<?= base_url('propertystaging/editproperty/' . $property->id) ?>" data-toggle="tooltip" title="Edit"
