        ...
        <div class="container container-xxl">
          ...
          <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30"
            ...
            <div class="box pb-7 pt-2">
              <div class="card shadow-hover-2" data-animate="zoomIn">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-02.jpg') ?>"
            ...
            <div class="box pb-7 pt-2">
              <div class="card shadow-hover-2" data-animate="zoomIn">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-01.jpg'); ?>"
            ...
            <div class="box pb-7 pt-2">
              <div class="card shadow-hover-2" data-animate="zoomIn">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-03.jpg'); ?>"
            ...
            <div class="box pb-7 pt-2">
              <div class="card shadow-hover-2" data-animate="zoomIn">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-04.jpg') ?>"
                             alt="Home in Metric Way">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge mr-2 badge-primary">for Sale</span>
        ...
        <div class="container container-xxl">
          ...
          <div class="slick-slider slick-dots-mt-0 custom-arrow-spacing-30"
            ...
            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
              <div class="card shadow-hover-2">
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                  ...
                  <ul class="list-inline mb-0">
                    <li class="list-inline-item">
                      <!-- Border-Hover-Accent == border only not filled -->
                      <!-- Border-Accent == heart filled -->
                      <!-- Text-red resposible for color -->
                      <a href=""
                        class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center text-red bg-accent border-accent"
                        data-toggle="tooltip" title="Wishlist"><i
                            class="fas fa-heart"></i></a>
                    </li>
                    <li class="list-inline-item">
            ...
            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
              <div class="card shadow-hover-2">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-05.jpg') ?>"
                             alt="Affordable Urban House">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge mr-2 badge-primary">for Sale</span>
            ...
            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
              <div class="card shadow-hover-2">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-06.jpg') ?>"
                             alt="Villa on Hollywood Boulevard">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge mr-2 badge-primary">for Sale</span>
            ...
            <div class="box box pb-7 pt-2" data-animate="fadeInUp">
              <div class="card shadow-hover-2">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                  <img src="<?= base_url('theme/images/properties-grid-07.jpg'); ?>"
                             alt="Home in Metric Way">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge mr-2 badge-primary">for Sale</span>
            ...
            <div class="row align-items-center">
              <div class="col-lg-6 pr-xl-8 pb-lg-0 pb-6" data-animate="fadeInLeft">
                <a href="#" class="hover-shine d-block">
                  <img src="<?= base_url('theme/images/single-image-01.jpg') ?>" class="rounded-lg w-100"
            ...
            <div class="slick-slider mx-0 partners"
              ...
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="<?= base_url('theme/images/partner-hover-1.png') ?>"
                             class="hover-image position-absolute pos-fixed-top" alt="Partner 1">
                  <img src="<?= base_url('theme/images/partner-1.png') ?>" alt="Partner 1"
                             class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="<?= base_url('theme/images/partner-hover-2.png') ?>"
                             class="hover-image position-absolute pos-fixed-top" alt="Partner 2">
                  <img src="<?= base_url('theme/images/partner-2.png') ?>" alt="Partner 2"
                             class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="<?= base_url('theme/images/partner-hover-3.png') ?>"
                             class="hover-image position-absolute pos-fixed-top" alt="Partner 3">
                  <img src="<?= base_url('theme/images/partner-3.png') ?>" alt="Partner 3"
                             class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item">
                  <img src="<?= base_url('theme/images/partner-4.png') ?>" alt=""
                             class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item position-relative hover-change-image">
                  <img src="<?= base_url('theme/images/partner-hover-5.png') ?>"
                             class="hover-image position-absolute pos-fixed-top" alt="Partner 5">
                  <img src="<?= base_url('theme/images/partner-5.png') ?>" alt="Partner 5"
                             class="image">
                </a>
              </div>
              <div class="box d-flex align-items-center justify-content-center" data-animate="fadeInUp">
                <a href="#" class="item">
                  <img src="<?= base_url('theme/images/partner-6.png') ?>" alt=""
                             class="image">
                </a>
              </div>
            </div>
