...
<main id="content" class="bg-gray-01">
    <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10 my-profile">
        <div class="mb-6">
        <h2 class="mb-0 text-heading fs-22 lh-15">Add Blog
        </h2>
                                        ...
                                        <div class="card mb-6">
                                            <div class="card-body p-6">
                                                ...
                                                <div class="form-group">
                                                    <label for="title" class="text-heading">Blog's Title
                                                ...
                                                <div class="form-row mx-n2">
                                                    <div class="col-md-6 col-lg-12 col-xxl-6 px-2 mb-4 mb-md-0">
                                                        <div class="form-group mb-0">
                                                            <label for="p_status" class="text-heading">Blog's Image</label>
