        ...
        <ul class="nav nav-pills border py-2 px-3 mb-6 d-none d-md-flex mb-6"
            ...
            <li class="nav-item col">
                <a class="nav-link active bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                    ...
                    <span class="number"></span> Add Blog
                </a>
            </li>
        </ul>
                    ...
                    <div class="card bg-transparent border-0">
                        <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0"
                            ...
                            <h5 class="mb-0">
                                ...
                                <span class="number"></span>Update Blog
                                </button>
                            </h5>
                        </div>
                            ...
                            <div class="card-body py-4 py-md-0 px-0">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card mb-6">
                                            <div class="card-body p-6">
                                                <h3 class="card-title mb-0 text-heading fs-22 lh-15">Blog's Information</h3>
                                                <p class="card-text mb-5">Please Enter Fields</p>
                                                <div class="form-group">
                                                    <label for="name" class="text-heading">Blog's Name
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card mb-6">
                                            <div class="card-body p-6">
                                                <h3 class="card-title mb-0 text-heading fs-22 lh-15">Blog Description</h3>
                                                <p class="card-text mb-5">Lorem ipsum dolor sit amet, consectetur
                                                adipiscing elit</p>
                                                <div class="form-group mb-0">
                                                    <label class="text-heading">Description</label>
                                                    <textarea class="form-control border-0" name="description" id="textcontent"><?= $blog['description'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
